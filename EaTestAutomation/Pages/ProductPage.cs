...
public class ProductPage : IProductPage
{
    ...
    private ILocator _selectProduct =>
        _page.GetByRole(AriaRole.Combobox, new PageGetByRoleOptions() { Name = "ProductType" });

    private ILocator _lnkCreate => _page.GetByRole(AriaRole.Button, new PageGetByRoleOptions() { Name = "Create" });
